...
def gen_plots(name, title, rand, ours, disg, cntb):
    ...
    gen_entropy_plot(
        "plots/entropy/" + name, title + " Entropy", rand, ours, disg, cntb
    )
...
lin_disg = np.array(
    [
        np.load(
            "baselines/logs_20trainsteps_bs32/disag_inverted_pendulum/dim_0_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
lin_cntb = np.array(
    [
        np.load("baselines/logs/count_inverted_pendulum/dim_0_seed_{i}.npy".format(i=i))
        for i in range(5)
    ]
)
...
ang_disg = np.array(
    [
        np.load(
            "baselines/logs_20trainsteps_bs32/disag_inverted_pendulum/dim_1_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
ang_cntb = np.array(
    [
        np.load("baselines/logs/count_inverted_pendulum/dim_1_seed_{i}.npy".format(i=i))
        for i in range(5)
    ]
)
...
for dim in range(4):
    ...
    disg = np.array(
        [
            np.load(
                "baselines/logs_20trainsteps_bs32/disag_hopper/dim_"
                + str(dim)
                + "_seed_{i}.npy".format(i=i)
            )
            for i in range(5)
        ]
    )
    cntb = np.array(
        [
            np.load(
                "baselines/logs/count_hopper/dim_"
                + str(dim)
                + "_seed_{i}.npy".format(i=i)
            )
            for i in range(5)
...
lin_disg = np.array(
    [
        np.load(
            "baselines/logs_20trainsteps_bs32/disag_inverted_double_pendulum/dim_0_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
lin_cntb = np.array(
    [
        np.load(
            "baselines/logs/count_inverted_double_pendulum/dim_0_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
ang_disg = np.array(
    [
        np.load(
            "baselines/logs_20trainsteps_bs32/disag_inverted_double_pendulum/dim_1_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
ang_cntb = np.array(
    [
        np.load(
            "baselines/logs/count_inverted_double_pendulum/dim_1_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
ang_disg = np.array(
    [
        np.load(
            "baselines/logs_20trainsteps_bs32/disag_inverted_double_pendulum/dim_2_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
...
ang_cntb = np.array(
    [
        np.load(
            "baselines/logs/count_inverted_double_pendulum/dim_2_seed_{i}.npy".format(
                i=i
            )
        )
        for i in range(5)
